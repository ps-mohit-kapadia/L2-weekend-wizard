...
class PromptingTests(unittest.TestCase):
    def test_build_react_messages_include_decision_schema_and_tools(self) -> None:
        ...
        self.assertIn('For "Get the weather for City A and City B using their coordinates.": city_to_coords for each location, then get_weather for each location, then finish.', messages[0]["content"])
